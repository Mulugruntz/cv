...
\else
	...
	\address{ \faMapMarker*~Pietersbergweg 53-B, 1105 BM, Amsterdam, Pays-Bas ~~ \faPassport~France \\ \faAt~samuel@giffard.co ~~ \faMobile*~+32 (0) 4-84-14-10-33 ~~ \faMobile*~+33 (0) 7-69-69-12-02 \\ \\ \textbf{\faPython~Formateur, Ing\'enieur \& \'Evang\'eliste Python}  }
\fi
...
\section{\faBriefcase~EXP\'ERIENCES PROFESSIONNELLES}
	...
	\begin{itemize}
		\item[] \textbf{Depuis F\'evrier 2022} \tabto{5cm} Ing\'enieur Logiciel (Python) \hfill Amsterdam -- Pays-Bas
		\begin{itemize}
			\item[+] D\'evelopeur Python pour la Plateforme Python de \textbf{Picnic} (Middleware).
		\end{itemize}
