...
\else
	...
	\address{ \faMapMarker~Brandstraat 24/101, 9000 Gent, Belgium \\ 📧 samuel@giffard.co ~~ \faMobile~+32 (0) 4-84-14-10-33 \\ \\ \textbf{Formateur, Ing\'enieur \& \'Evang\'eliste Python}  }
\fi
...
\section{COMP\'ETENCES} 
	\begin{itemize}
		\item[] \textbf{Langues}
		\begin{itemize}
                 \item[+]  \textbf{Fran\c{c}ais}: langue maternelle, \textbf{Anglais}: bilingue, \textbf{Flamand}: bases, \textbf{Espagnol}: notions \'el\'ementaires
		\end{itemize}	
	\end{itemize}
...
\section{EXP\'ERIENCES PROFESSIONNELLES}
	...
	\begin{itemize}
		\item[] Depuis F\'evrier  2018 \tabto{5cm} DevOps (Python, Jenkins, Groovy, GCP, PowerShell, Docker) \hfill Gand -- Belgique
		\begin{itemize}
