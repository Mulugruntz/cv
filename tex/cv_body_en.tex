...
%                \item[+] When working for Amadeus, supervised interns
%                    \begin{itemize}
%                        \item[+] one for three months on his Django project, which had to deal with monitoring and comparing versions in our replicated data.
%                        \item[+] one for six months in his Node.js / Aria Template project. We worked as a mini scrum team, where I worked on infrastructure-related tasks.
%                    \end{itemize} 
...
\section{WORK EXPERIENCES}
        \begin{itemize}
                ...
                \begin{itemize}
                        ...
                        %: a news engine, email engine, and some customized modules required by the client (website can be populated through MS Excel). The client provided the visual design of the website.
                \end{itemize}
                ...
                \begin{itemize}
                        ...
                        % The original idea, its challenges and the proof that it would not be viable in a cheap environment earnt me a double-A.
                \end{itemize}
                \item[] Feb. - May 2009 \tabto{5cm} Observation placement in Middle School (Technology) \hfill Montauban -- France
%                \begin{itemize}
%                        \item[] Helping students, assisting the teacher and lecturing on my own for the last session.
%                        \ifisanon \else School name: \textit{Coll\`ege Ingres}.\fi
%                \end{itemize}
                \item[] June - Aug. 2008 \tabto{5cm} Internship (PHP, JS, HTML/CSS) \hfill Toulouse -- France
%                \begin{itemize}
%                        \item[] Creation of \ifisanon www....fr \textit{(Anonymous)} \else www.amar-abraham.fr , \fi a fashion designer website.
%                \end{itemize}
                \item[] Oct. - Nov. 2007 \tabto{5cm} IT Maintenance for \textbf{CROUS de Toulouse} (public establishment) \hfill Toulouse -- France
%                \begin{itemize}
%                        \item[] CROUS deals with things related to studies and students in one academy. My job there was to set up WIFI installations on two student campuses. I was recommended for the job by one of the campus directors.
%                \end{itemize}
        \end{itemize}
