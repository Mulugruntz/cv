...
\else
        ...
        \address{ \faMapMarker~Brandstraat 24/101, 9000 Gent, Belgium \\ 📧 samuel@giffard.co ~~ \faMobile~+32 (0) 4-84-14-10-33 \\ \\ \textbf{Python Trainer, Engineer \& Evangelist} }
\fi
...
\section{\faBriefcase~WORK EXPERIENCES}
        \begin{itemize}
					\item[] Feb.  2018 - Now \tabto{5cm} DevOps (Python, Jenkins, Groovy, GCP, PowerShell, Docker) \hfill Ghent -- Belgium
					\begin{itemize}
