...
\else
        ...
        \address{ \faMapMarker*~Pietersbergweg 53-B, 1105 BM, Amsterdam, NL ~~ \faPassport~France \\ \faAt~samuel@giffard.co ~~ \faMobile*~+33 (0) 7-69-69-12-02 ~~ \faWhatsapp~+32 (0) 4-84-14-10-33 \\ \\ \textbf{\faPython~Python Trainer, Engineer \& Evangelist} }
\fi
...
\section{\faBriefcase~WORK EXPERIENCES}
        \begin{itemize}
                    \item[] \textbf{Since Feb. 2022} \tabto{5cm} Software Engineer (Python, FastAPI, Docker, Hiring) \hfill Amsterdam -- Netherlands
                    \begin{itemize}
